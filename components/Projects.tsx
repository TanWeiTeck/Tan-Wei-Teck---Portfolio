...
const Projects = ({ projects }: Props) => {
    ...
    return (
        ...
        >
            ...
            <div className=" w-full flex overflow-x-scroll space-x-5 snap-x snap-mandatory scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-secondary">
                {projects.map((project, index) => (
                    <div
                        key={index}
                        className="min-w-full snap-center flex flex-col space-y-5 items-center justify-start md:px-10 pb-10"
                    >
                        {showModal && project?.screenShots && (
                            <Modal
                                key={project._id}
